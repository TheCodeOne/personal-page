(() => {
      ...
      _getObserver() {
        ...
        return (e = this._observer) !== null && e !== void 0
          ...
          : (this._observer = new ResizeObserver((t) => {
              var s;
              for (let l of t) de.entries.set(l.target, l), (s = this._listeners.get(l.target)) === null || s === void 0 || s(l);
            }));
      }
    };
  ...
  var $e = class {
    ...
    m(e, t, s = null) {
      this.e || (this.is_svg ? (this.e = Ts(t.nodeName)) : (this.e = C(t.nodeType === 11 ? "TEMPLATE" : t.nodeName)), (this.t = t.tagName !== "TEMPLATE" ? t : t.content), this.c(e)), this.i(s);
    }
    h(e) {
  ...
  function gn(n, e, t, s, l, r, i, a, o, h, c, m) {
    ...
    for (_ = d; _--; ) {
      let v = m(l, r, _),
        F = t(v),
        O = i.get(F);
      O ? s && M.push(() => O.p(v, e)) : ((O = h(F, v)), O.c()), T.set(F, (f[_] = O)), F in u && R.set(F, Math.abs(_ - u[F]));
    }
    let U = new Set(),
      X = new Set();
    function W(v) {
    ...
    for (; p && d; ) {
      let v = f[d - 1],
        ...
        O = v.key,
        V = F.key;
      v === F ? ((c = v.first), p--, d--) : T.has(V) ? (!i.has(O) || U.has(O) ? W(v) : X.has(V) ? p-- : R.get(O) > R.get(V) ? (X.add(O), W(v)) : (U.add(V), p--)) : (o(F, i), p--);
    }
    for (; p--; ) {
      let v = n[p];
      T.has(v.key) || o(v, i);
  ...
  function ue(n, e) {
    let t = n.$$;
    t.fragment !== null && (Ms(t.after_update), G(t.on_destroy), t.fragment && t.fragment.d(e), (t.on_destroy = t.fragment = null), (t.ctx = []));
  }
  function vs(n, e) {
    ...
    if (
      ((h.ctx = t
        ? t(n, e.props || {}, (m, p, ...d) => {
            ...
            return h.ctx && l(h.ctx[m], (h.ctx[m] = _)) && (!h.skip_bound && h.bound[m] && h.bound[m](_), c && vs(n, m)), p;
          })
        : []),
      h.update(),
      (c = !0),
  ...
  function tt(n, e = {}) {
    ...
    if (Fs.call(mt, l)) {
      let a = mt[l];
      return (e.normalize === void 0 || e.normalize === null || e.normalize) && typeof a == "string" ? tt(a) : ((t[Rn.includes(l) ? "regular" : "irregular"] = s), t);
    }
    for (; I(l.charCodeAt(r)) && r < 9; ) r++;
    if (r > 1 && r < 9) {
      if (((t.language = s.slice(0, r)), r < 4)) {
        let a = 0;
        for (; l.charCodeAt(r) === 45 && I(l.charCodeAt(r + 1)) && I(l.charCodeAt(r + 2)) && I(l.charCodeAt(r + 3)) && !I(l.charCodeAt(r + 4)); ) {
      ...
      for (
        l.charCodeAt(r) === 45 && I(l.charCodeAt(r + 1)) && I(l.charCodeAt(r + 2)) && I(l.charCodeAt(r + 3)) && I(l.charCodeAt(r + 4)) && !I(l.charCodeAt(r + 5)) && ((t.script = s.slice(r + 1, r + 5)), (r += 5)),
          l.charCodeAt(r) === 45 &&
            (I(l.charCodeAt(r + 1)) && I(l.charCodeAt(r + 2)) && !I(l.charCodeAt(r + 3))
              ? ((t.region = s.slice(r + 1, r + 3)), (r += 3))
              : $(l.charCodeAt(r + 1)) && $(l.charCodeAt(r + 2)) && $(l.charCodeAt(r + 3)) && !$(l.charCodeAt(r + 4)) && ((t.region = s.slice(r + 1, r + 4)), (r += 4)));
        l.charCodeAt(r) === 45;
      ...
      for (; l.charCodeAt(r) === 45 && !(l.charCodeAt(r + 1) === 120 || !Z(l.charCodeAt(r + 1)) || l.charCodeAt(r + 2) !== 45 || !Z(l.charCodeAt(r + 3))); ) {
        let a = r + 2,
          o = 0;
  ...
  function Ns(n) {
    ...
    return {
      ...
      m(_, u) {
        p && p.m(_, u), y(_, e, u), y(_, t, u), b(t, s), b(s, l), b(l, i), b(t, o), b(t, h), (h.innerHTML = c), b(t, m), d && d.m(t, null);
      },
      p(_, u) {
  ...
  function yn(n) {
    ...
    return {
      ...
      p(l, r) {
        r & 2 && !ie(e.src, (t = l[1].meta?.image)) && E(e, "src", t), r & 2 && s !== (s = l[1].meta?.image_alt || l[1].meta?.title) && E(e, "alt", s);
      },
      d(l) {
        l && k(e);
      },
  ...
  function Mn(n) {
    ...
    return {
      c() {
        (e = C("li")), (s = w(t)), (l = w(": ")), (i = w(r)), (a = A()), E(e, "class", "pagefind-ui__result-tag svelte-j9e30");
      },
      m(o, h) {
  ...
  function zs(n, e, t) {
    let { show_images: s = !0 } = e,
      ...
      o = [],
      h = async (m) => {
        t(1, (a = await m.data())), t(1, (a = l?.(a) ?? a)), t(2, (o = Object.entries(a.meta).filter(([p]) => !i.includes(p))));
      },
      c = (m = 30) => ". ".repeat(Math.floor(10 + Math.random() * m));
    return (
      (n.$$set = (m) => {
        "show_images" in m && t(0, (s = m.show_images)), "process_result" in m && t(4, (l = m.process_result)), "result" in m && t(5, (r = m.result));
      }),
      (n.$$.update = () => {
        if (n.$$.dirty & 32) e: h(r);
      }),
  ...
  function jn(n) {
    ...
    return {
      ...
      p(c, m) {
        m & 8 && l !== (l = c[15].title + "") && N(r, l), m & 8 && i !== (i = c[15].url) && E(s, "href", i), m & 8 && h !== (h = c[15].excerpt + "") && (o.innerHTML = h);
      },
      d(c) {
        c && k(e);
      },
  ...
  function Un(n) {
    ...
    return {
      c() {
        (e = C("li")), (s = w(t)), (l = w(": ")), (i = w(r)), (a = A()), E(e, "class", "pagefind-ui__result-tag svelte-4xnkmf");
      },
      m(o, h) {
        y(o, e, h), b(e, s), b(e, l), b(e, i), b(e, a);
      },
    ...
    let { show_images: s = !0 } = e,
      ...
      p = async (_) => {
        t(1, (a = await _.data())),
          ...
          Array.isArray(a.sub_results) && (t(4, (c = a.sub_results?.[0]?.url === (a.meta?.url || a.url))), c ? t(3, (h = m(a.sub_results.slice(1), 3))) : t(3, (h = m([...a.sub_results], 3))));
      },
      d = (_ = 30) => ". ".repeat(Math.floor(10 + Math.random() * _));
    return (
      (n.$$set = (_) => {
        "show_images" in _ && t(0, (s = _.show_images)), "process_result" in _ && t(6, (l = _.process_result)), "result" in _ && t(7, (r = _.result));
      }),
      (n.$$.update = () => {
  ...
  function Wn(n) {
    ...
    return {
      ...
      m(M, U) {
        y(M, e, U), b(e, t), (t.checked = n[0][`${n[10]}:${n[14]}`]), b(e, i), b(e, a), o.m(h, a), b(a, c), b(a, p), b(a, d), b(e, u), f || ((T = J(t, "change", R)), (f = !0));
      },
      p(M, U) {
        (n = M),
  ...
  function Vn(n) {
    ...
    return {
      ...
      p(s, l) {
        s[2] || s[15] || s[0][`${s[10]}:${s[14]}`] ? (t ? t.p(s, l) : ((t = Wn(s)), t.c(), t.m(e.parentNode, e))) : t && (t.d(1), (t = null));
      },
      d(s) {
        t && t.d(s), s && k(e);
      },
  ...
  function Gn(n) {
    ...
    return {
      ...
      p(d, _) {
        if ((_ & 2 && s !== (s = d[10].replace(/^(\w)/, Kn) + "") && (t.innerHTML = s), _ & 2 && a !== (a = d[10] + "") && (i.innerHTML = a), _ & 7)) {
  ...
  function Ps(n) {
    ...
    return {
      ...
      p(l, [r]) {
        r & 2 && (e = l[1] && Object.entries(l[1]).length), e ? (s ? s.p(l, r) : ((s = Bn(l)), s.c(), s.m(t.parentNode, t))) : s && (s.d(1), (s = null));
      },
      i: j,
      o: j,
      d(l) {
  ...
  var Et = class extends q {
      constructor(e) {
        super(), Y(this, e, Ls, Ps, K, { available_filters: 1, show_empty_filters: 2, open_filters: 3, translate: 4, automatic_translations: 5, translations: 6, selected_filters: 0 });
      }
    },
    Yn = Et;
  var Rt = {};
  ...
  var Zi = [Rt, bt, Tt, Ct, kt, yt, St, Mt, At, vt, wt, Ft, Ht, Nt, Ot, zt, jt, Dt, Ut, It, Pt, Lt, qt, Bt, Wt, Vt, Gt, Kt, Jt, Yt, Zt, Xt, Qt, xt],
    Zn = Zi,
    Xn = [
  ...
  function xn(n) {
    ...
    let r = { show_empty_filters: n[5], open_filters: n[6], available_filters: n[18], translate: n[20], automatic_translations: n[19], translations: n[7] };
    return (
    ...
    return {
      ...
      p(u, f) {
        c === (c = h(u, f)) && m ? m.p(u, f) : (m.d(1), (m = c(u)), m && (m.c(), m.m(e, null))),
          f[0] & 139292 && ((p = u[13].results.slice(0, u[17])), ae(), (l = gn(l, f, d, 1, u, p, r, s, pn, es, null, Qn)), oe()),
          u[13].results.length > u[17] ? (_ ? _.p(u, f) : ((_ = ts(u)), _.c(), _.m(a.parentNode, a))) : _ && (_.d(1), (_ = null));
      },
      i(u) {
        if (!o) {
  ...
  function ta(n) {
    ...
    return {
      ...
      p(s, l) {
        l[0] & 589952 && e !== (e = s[20]("zero_results", s[19], s[7]).replace(/\[SEARCH_TERM\]/, s[16]) + "") && N(t, e);
      },
      d(s) {
        s && k(t);
      },
  ...
  function na(n) {
    ...
    return (
      (e = new vn({ props: { show_images: n[2], process_result: n[4], result: n[51] } })),
      {
        ...
        p(s, l) {
          let r = {};
          l[0] & 4 && (r.show_images = s[2]), l[0] & 16 && (r.process_result = s[4]), l[0] & 139264 && (r.result = s[51]), e.$set(r);
        },
        i(s) {
    ...
    return {
      ...
      m(R, M) {
        y(R, e, M),
          ...
          (d = !0),
          n[8] && s.focus(),
          _ || ((u = [J(s, "focus", n[21]), J(s, "keydown", n[32]), J(s, "input", n[33]), J(i, "click", n[36]), J(t, "submit", ra)]), (_ = !0));
      },
      p(R, M) {
  ...
  function ia(n, e, t) {
    ...
    dt(() => {
      ...
      t(19, (rn = s[`${H.language}-${H.script}-${H.region}`] || s[`${H.language}-${H.region}`] || s[`${H.language}`] || s.en));
    }),
      ht(() => {
        F?.destroy?.(), (F = null);
      });
...
`)
      ...
      os = async (g, H) => {
        ...
        let z = as(H),
          L = () => us(g, z);
        u > 0 && g ? (_e && clearTimeout(_e), (_e = setTimeout(L, u)), await on(), F.preload(g, { filters: z })) : L(), cs();
      },
      on = async () => {
      ...
      us = async (g, H) => {
        ...
        nn === z && (te.filters && Object.keys(te.filters)?.length && t(18, (ce = te.filters)), t(13, (tn = te)), t(14, (lt = !1)), t(17, (it = i)));
      },
      cs = () => {
        let g = V.offsetWidth;
    ...
    return (
      ...
      [W, a, o, h, m, d, _, M, U, v, O, V, st, tn, lt, rt, sn, it, ce, rn, rs, an, _s, R, c, r, i, p, u, f, T, X, fs, ds, hs, ms, ps, gs]
    );
  }
