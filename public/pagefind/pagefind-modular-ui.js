(() => {
      ...
      initContainer(e) {
        ...
        if (t.tagName === "INPUT")
          ...
          new r("label")
            ...
            .addTo(n),
            (this.inputEl = new r("input").id(`pfmod-input-${s}`).class("pagefind-modular-input").attrs({ autocapitalize: "none", enterkeyhint: "search" }).addTo(n)),
  ...
  var g = (i) => {
    ...
    d = class {
      constructor(e = {}) {
        (this.rawResult = e.result), (this.placeholderNodes = e.placeholderNodes), (this.resultFn = e.resultFn), (this.intersectionEl = e.intersectionEl), (this.result = null), this.waitForIntersection();
      }
      waitForIntersection() {
        ...
        e.on("results", (t) => {
          this.containerEl &&
            ...
            (this.results = t.results.map((s) => {
              ...
              return this.append(n), new d({ result: s, placeholderNodes: n, resultFn: this.resultTemplate, intersectionEl: this.intersectionEl });
            })));
        }),
          e.on("loading", () => {
  ...
  var h = class {
    ...
    initContainer(e) {
      ...
      this.alwaysShow || n.attrs({ "data-pfmod-hidden": !0 }),
        new r("div").id(s).class("pagefind-modular-filter-pills-label").attrs({ "data-pfmod-sr-hidden": !0 }).text(`Filter results by ${this.filter}`).addTo(n),
    ...
    renderNew() {
      this.available.forEach(([e, t]) => {
        new r("button")
          ...
          .handle("click", () => {
            e === "All" ? (this.selected = ["All"]) : this.selected.includes(e) ? (this.selected = this.selected.filter((s) => s !== e)) : this.selectMultiple ? this.selected.push(e) : (this.selected = [e]),
              this.selected?.length ? this.selected?.length > 1 && (this.selected = this.selected.filter((s) => s !== "All")) : (this.selected = ["All"]),
              this.update(),
              this.pushFilters();
          })
      ...
      (this.instance = e),
        ...
        e.on("results", (t) => {
          this.pillContainer &&
            ...
            this.total || this.alwaysShow ? this.wrapper.removeAttribute("data-pfmod-hidden") : this.wrapper.setAttribute("data-pfmod-hidden", "true"),
            this.update());
        });
    }
  };
    ...
    async __search__(e, t) {
      ...
      n &&
        ...
        (n.filters &&
          ...
          ((this.availableFilters = n.filters), (this.totalFilters = n.totalFilters), this.__dispatch__("filters", { available: this.availableFilters, total: this.totalFilters })),
        (this.searchResult = n),
