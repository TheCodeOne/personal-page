...
3.  **Architektur:** Wir müssen akzeptieren, dass wir die Softwarearchitektur eventuell anpassen müssen, um diese Teamstruktur zu ermöglichen ("Inverse Conway Maneuver").
